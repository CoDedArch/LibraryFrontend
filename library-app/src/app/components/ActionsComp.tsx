...
const ActionsComp: React.FC<ActionsProps> = ({ book, img, action, alt }) => {
  const requires_login =
    "Hi There! to stream, download, share, rate, or ask question, you need to Log in";
  ...
  return (
    <>
      <div
        className={`absolute top-[23em] md:top-[4em] z-[20000] right-2 md:-right-[5em] w-[20em] h-[3em] md:h-[5em] rounded-md flex flex-col justify-center text-center border-2 border-green-800 shadow-md bg-red-400 md:bg-opacity-50 ${
