...
const BookTitleComp: React.FC<BookProps> = ({ book }) => {
  return (
    <div className="">
      <p className="mt-2">
        An edition of{" "}
        <span className="underline font-body italic font-bold">{book.title}</span> (
        {book.publication_date})
      </p>
      <h1 className="text-3xl md:text-5xl md:w-[10em] font-sub text-stylish-600">{book.title}</h1>
      <p className="mt-1">
