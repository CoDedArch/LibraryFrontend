...
export default function Signup() {
  ...
  return (
    <>
      <div
        className={`absolute top-[10em] md:top-[7em] right-2 md:left-[15em] w-[20em] h-[3em] md:h-[5em] rounded-md flex flex-col justify-center text-center border-2 border-green-800 ${
          showMessage ? "" : "hidden"
        } ${messageStyle}`}
      >
        <p>{message}</p>
      ...
      <section className="mt-[3em] md:mt-0 md:flex bg-orange-200 md:mx-[15em] bg-opacity-25 h-fit justify-between rounded-md">
        <div className="hidden w-1/2 md:flex flex-col justify-center px-7 border-r-2 border-r-creamy-100">
          ...
          <h2 className="pt-2 text-xl font-light">
            ...
            <span className=" italic font-extrabold underline">Student</span>
          </h2>
        </div>
